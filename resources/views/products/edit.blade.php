        ...
        <div class="main-wrapper main-wrapper-1">
            ...
            <div class="form-floating mb-3">
                ...
                <input type="text" name="description" class="form-control" id="floatingPassword"placeholder="description"
                    value="{{ $produks_tabel->description }}">
            </div>
            <div class="form-floating mb-3">
